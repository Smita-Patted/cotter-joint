...
df = pd.read_excel(r"D:\Codes\Cotter Joint Project\material_sheet.xlsx")
# print(df)
...
d1=round(d1_)
if d1%2==0:
    # print("Diameter of Cotter Hole 'd1' is:",d1,"mm")
...
t = (d1t/d1)
print("Thickness of Cotter 't' :",round(t,3),'mm')
...
#     if(t3_%2!=0):
#         t3_=t3_+1
#         print("Since t2 is",t2_," adopting next even number ie:",t3_)
#     else:
#         print("Since t2 is",t2_," adopting next even number ie:",t3_)
